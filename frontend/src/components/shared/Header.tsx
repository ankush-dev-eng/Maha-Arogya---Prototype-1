        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex items-center gap-2 pl-2 sm:pl-3 border-l border-slate-800">
            <button
              ...
              className="flex items-center gap-2 p-1 sm:px-3 sm:py-1.5 rounded-xl bg-slate-800 border border-slate-700 hover:border-teal-500/50 hover:bg-slate-750 transition-all text-left group cursor-pointer"
            >
            ...
            <Button 
              ...
              className="text-slate-400 hover:text-red-400 hover:bg-slate-800 h-9 w-9 rounded-xl cursor-pointer" 
